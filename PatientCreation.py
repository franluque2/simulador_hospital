...
def generate_rand_name(sex):  # TODO: REEMPLAZAR POR UNA FUNCION DE VERDAD
    if sex == "M":
        return "Jorge"
    if sex == "F":
        return "Maria"
...
def str_to_illness(illness, name):  # TODO: REEMPLAZAR POR UNA FUNCION DE VERDAD
    if illness == "Malaria":
        return illnesses.malaria.Malaria(None, name)
    if illness == "Coronavirus (Delta)":
        return illnesses.coronavirus.CoronavirusDelta(None, name)
    if illness == "cancer":
...
def generate_patient(args=None):
    ...
    if "age" in args and args["age"] is not None:
        ...
        patient["age"] = random.randint(25, 60)

    if "src" in args and args["src"] is not None:
        patient["src"] = args["src"]
    else:
        patient[
            "src"] = "¯\\_(ツ)_/¯"  # TODO: TOMAR SRC DE THISPERSONDOESNOTEXIST O OTRO GENERADOR DE IMAGENES DE PERSONAS o generar avatares

    if "personaldata" in args and args["personaldata"] is not None:
        patient["personaldata"] = args["personaldata"]
    else:
        patient["personaldata"] = {}  # TODO: GENERAR DATOS PERSONALES
    ...
    if "physeval" in args and args["physeval"] is not None:
        ...
        patient["physeval"] = {}  # TODO: GENERAR PHYSEVAL
    ...
    if "risk_factors" in args and args["risk_factors"] is not None:
        ...
        patient["risk_factors"] = {}  # TODO: GENERAR FACTORES DE RIESGO

    if "motive" in args and args["motive"] is not None:
        patient["motive"] = args["motive"]
    else:
        patient["motive"] = ""  # TODO: GENERAR MOTIVO
    ...
    if "summary" in args and args["summary"] is not None:
        ...
        patient["summary"] = ""  # TODO: GENERAR RESUMEN
